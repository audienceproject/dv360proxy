...
We offer two ways for deployment (AWS Serverless Application Model)[https://docs.aws.amazon.com/serverless-application-model/] and (Terraform)[https://www.terraform.io/]. Based on practices within your organization, feel free to chose one or another. In both cases, you need to clone the repository and run 
